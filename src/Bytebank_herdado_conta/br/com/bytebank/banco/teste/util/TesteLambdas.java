...
public class TesteLambdas {
	...
	public static void main(String[] args) {
		...
		System.out.println("\nOrdenação por número da conta");
		
		lista.sort((conta_1, conta_2) -> Integer.compare(conta_1.getNumero(), conta_2.getNumero()));

		Comparator<Conta> comparador = (Conta conta_1, Conta conta_2) -> {
		...
		System.out.println("\nOrdenação alfabética por nome do titular");
